...
final List<Element> elements = [
  ...
  Element('Pa', Colors.orange, 91, 10, 4),
  Element('U', Colors.grey, 92, 10, 5),
  Element('Np', Colors.grey, 93, 10, 6),
  Element('Pu', Colors.orange, 94, 10  , 7),
  Element('Am', Colors.grey, 95, 10, 8),
  Element('Cm', Colors.red, 96, 10, 9),
  Element('Bk', Colors.grey, 97, 10, 10),
  Element('Cf', Colors.orange, 98, 10, 11),
  Element('Es', Colors.grey, 99, 10, 12),
  Element('Fm', Colors.orange, 100, 10, 13),
  Element('Md', Colors.green, 101, 10, 14),
  Element('No', Colors.blue, 102, 10, 15),
  Element('Lr', Colors.grey, 103, 10, 16),
  Element('Rf', Colors.orange, 104, 10, 17),
  Element('Db', Colors.blue, 105, 9, 17),
  Element('As', Colors.grey, 105, 9, 16),
  Element('Sg', Colors.orange, 106, 9, 3),
  Element('Bh', Colors.grey, 107, 9, 4),
  Element('Hs', Colors.green, 108, 9, 5),
  Element('Mt', Colors.grey, 109, 9, 6),
  Element('Ds', Colors.blue, 110, 9, 7),
  Element('Rg', Colors.grey, 111, 9, 8),
  Element('Cn', Colors.orange, 112, 9, 9),
  Element('Nh', Colors.grey, 113, 9, 10),
  Element('Fl', Colors.green, 114, 9, 11),
  Element('Mc', Colors.grey, 115, 9, 12),
  Element('Lv', Colors.blue, 116, 9, 13),
  Element('Ts', Colors.green, 117, 9, 14),
  Element('Og', Colors.orange, 118, 9, 15),
];
